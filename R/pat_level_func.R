...
#' demonstrate statistical quality of the neighbors-based prediction.  #' The parameters are bias, coverage and the 50% prediction interval 
#' width.
#' 
...
pat_level_func <- function(
                           ...
                           outcome=outcome, time_elapsed=time_elapsed, idname=idname,
                           plot = plot,
    ...
    if(!is.null(parallel)){
        ...
        loocvres <- foreach(
                            ...
                            .export=c("ord_data", "train_post", "test_post","spl","ptr_m", "d_f_m", "d_f_s",
                                      ...
                                      "outcome","time_elapsed","idname","plot", "matchprobweight","time_window",
            ...
            for (i in patlistint) {
                ...
                matchmodel <- matchTrainDataGen(train_post=train_post, 
                                                ...
                                                time_elapsed=time_elapsed,idname=idname,
                                                outcome = outcome,
