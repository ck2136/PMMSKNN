# FILEINFO {{{
# Filename      : test_plmout.R
# Purpose       : Test plmout() Function
# Date created  : Fri 13 August 2021 07:42:49 AM MDT
# Last modified : Fri 13 August 2021 07:53:53 AM MDT
# Created by    : ck1
# Modified by   : ck1
# }}}

# LOOCV: Non Parallel {{{
context("Running plmout using ChickWeight Data")

test_that(
  "plmout() scenario where timewindow is used during loocv ",
  {
    data("ChickWeight") 
    ...
    # expect time window to change
    fin_tw <- loocv_function(
